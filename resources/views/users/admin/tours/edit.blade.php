...
@section('content')
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <h3 style="margin-bottom: 20px">Edit Tour / <a href="{{ route('tour.show', $tour->id) }}" target="_blank" style="text-decoration: underline">{{ ucwords($tour->getTranslation('en')->title) }}</a></h3>
                @if(session('message'))
                    <p style="color: green">{{ session('message') }}</p>
                @endif
                <form action="{{ route('admin.tours.update', $tour->id) }}" method="POST" class="needs-validation" enctype="multipart/form-data">
                    <div class="form-row">
                        <div class="col-md-4 mb-3">
                            ...
                            <select name="parent_id" id="tour_parent" class="form-control">
                                ...
                                @foreach($tours as $item)
                                    <option value="{{ $item->id }}">{{ ucwords($item->getTranslation('en')->title) }}</option>
                    ...
                    <div class="form-row">
                        <div class="col-md-4 mb-3">
                            <label for="inputGroupFile01">Picture - {{ $tour->picture ?? 'null' }}</label>
                    ...
                    <div class="form-row">
                        <div class="col-md-4 mb-3">
                            ...
                            <input name="title_hy" type="text" class="form-control" id="validationCustom01"
                                   ...
                                   value="{{ ucwords($tour->getTranslation('en')->title) }}" required>
                        </div>
                    </div>
                    <div class="form-row">
                        <div class="col-md-4 mb-3">
                    ...
                    <div class="form-row">
                        <div class="col-md-8 mb-6">
                            ...
                            <textarea name="desc_hy" class="form-control" cols="30" rows="10" placeholder="Armenian"
                                      required>{{ $tour->getTranslation('hy')->description }}</textarea>
                        </div>
                    </div>
                    <div class="form-row">
                        <div class="col-md-8 mb-6">
                            ...
                            <textarea name="desc_ru" class="form-control" cols="30" rows="10" placeholder="Russian"
                                      required>{{ $tour->getTranslation('ru')->description }}</textarea>
                        </div>
                    </div>
                    <div class="form-row">
                        <div class="col-md-8 mb-6">
                            ...
                            <textarea name="desc_en" class="form-control" cols="30" rows="10" placeholder="English"
                                      required>{{ $tour->getTranslation('en')->description }}</textarea>
                        </div>
                    </div>
